jQuery(function () {
    ...
    n = WebUploader.create({
        ...
        var str  = '<div class="col-sm-12" id="'+response._raw+'">'+
                        '<div class="col-sm-8">'+
                            '<input name="fileName" value="'+response._raw+'" readonly style="background-color: white;border: none;outline: none;" class="form-control" type="hidden">'+
                            '<input  value="'+response._raw+'.png" readonly style="background-color: white;border: none;outline: none;" class="form-control" type="text">'+
                        '</div>'+
