    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a class="admin-exit">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        <div class="logo-element"> <i class="glyphicon glyphicon-home"></i></div>
                    </li>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">${itm.menu.title}</span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a  class="admin-exit  roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2018-2019 <a href="#" target="_blank">乐潮之镜</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
