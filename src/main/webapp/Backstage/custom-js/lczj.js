...
$(document).ready(function(){
    ...
    $("#btn_add_save").click(function(e){
        var delok = true;
        var params={};
        params.admin = $('#lczj_add_lczj').val();
        params.name =$('#lczj_add_name').val();
        params.isvalid = '1';
    ...
    table.on('click', '.edit', function (e) {
        ...
        //alert(aData[0]);
        $('#lczj_edit_lczj').val(aData[0]);
        $('#lczj_edit_name').val(aData[1]);
        //  console.log((aData[2]=='有效'? '1':'0'));
        $('#lczj_edit_isvalid').val((aData[2]=='有效'? '1':'0'));
        $('#lczj_edit_modal').modal('show')
    });
    ...
    $("#btn_edit_save").click(function(e){
        ...
        var delok = true;
        var params={};
        var validValue = $('#lczj_edit_isvalid').val();
        params.admin = $('#lczj_edit_lczj').val();
        params.name =$('#lczj_edit_name').val();
        ...
        table.fnUpdate($('#lczj_edit_lczj').val(), nRow, 0, false);
        table.fnUpdate($('#lczj_edit_name').val(), nRow, 1, false);
        table.fnUpdate(validValue == 1 ? '有效':'无效', nRow, 2, false);
        table.fnDraw();
        $('#lczj_edit_lczj').val('');
        $('#lczj_edit_name').val('');
        validValue == 1 ? '有效':'无效';
        $('#lczj_edit_modal').modal('hide')
        swal({
            title: "保存成功！",
            text: "",
            type: "success",
