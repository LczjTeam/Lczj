...
import jx.lczj.exception.NoAuthorityException;
import jx.lczj.exception.NoLoginException;
...
// 任何通知方法都可以将第一个参数定义为 org.aspectj.lang.JoinPoint类型
    ...
    public void doBefore(JoinPoint call) throws Exception{
        ...
        if (session.getAttribute("admin") == null) {
            ...
            throw new NoLoginException("你尚未登录");
            ...
            if (!ok) {
                ...
                throw new NoAuthorityException("权限不足！！");
            }
        }
